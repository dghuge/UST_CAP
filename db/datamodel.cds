...
using { ust.mycapapp.db.common } from './commons';
...
context transaction {
    entity purchaseorder: common.Amount,cuid{
        ...
        OVERALL_STATUS: String(1) default 'N' @title : '{i18n>OVERALL_STATUS}';
        Items: Composition of  many poitems on Items.PARENT_KEY = $self;
    }

    entity poitems: common.Amount,cuid{
        //key NODE_KEY: common.Guid @title : '{i18n>PO_ITEM_NODE_KEY}';
        PARENT_KEY: Association to purchaseorder @title : '{i18n>PARTNER_KEY}';
